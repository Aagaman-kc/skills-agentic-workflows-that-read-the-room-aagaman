...
- **Do not compile workflows**: When creating or editing agentic workflow files, only create or update the markdown workflow file. Do not compile them. Compilation will be handled by the user or CI/CD as needed.
...
- **Workflow creation**: When creating or editing agentic workflow files, do not compile them. Only create or update the markdown workflow file.
